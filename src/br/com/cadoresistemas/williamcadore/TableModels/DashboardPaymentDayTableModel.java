...
public class DashboardPaymentDayTableModel {
    ...
    public DashboardPaymentDayTableModel(long id,String id_truck, String pago_a, String data_vencimento, String valor, String identificacao) {
        this.id = id;
