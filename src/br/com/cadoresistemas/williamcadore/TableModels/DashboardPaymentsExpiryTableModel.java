...
public class DashboardPaymentsExpiryTableModel {
    ...
    public DashboardPaymentsExpiryTableModel(long id,String id_truck, String pago_a, String data_vencimento, String valor, String identificacao) {
        this.id = id;
